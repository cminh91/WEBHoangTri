  ...
  const onSubmit = async (data: FormValues) => {
    ...
    try {
      ...
      if (!response.ok) {
        ...
        throw new Error(error.error || "Đã xảy ra lỗi khi tạo FAQ")
      }
      ...
      toast({
        title: "Lỗi",
        description: error instanceof Error ? error.message : "Đã xảy ra lỗi khi tạo FAQ",
        variant: "destructive",
      })
    } finally {
  ...
  return (
    <div className="p-6 space-y-6">
      <div className="flex items-center gap-2">
        ...
        <h1 className="text-2xl font-bold">Thêm FAQ Mới</h1>
      </div>

      <Card className="border-zinc-800 bg-zinc-950">
        <CardHeader>
          <CardTitle>Thông tin FAQ</CardTitle>
          <CardDescription>Tạo câu hỏi thường gặp mới cho website</CardDescription>
        </CardHeader>
        <CardContent>
          <Form {...form}>
