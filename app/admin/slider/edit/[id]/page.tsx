...
export default function EditSliderPage({ params }: { params: { id: string } }) {
  ...
  useEffect(() => {
    const fetchSlider = async () => {
      try {
        ...
        toast({
          title: "Lỗi",
          description: "Không thể tải thông tin slider",
          variant: "destructive",
        })
      }
    }
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      toast({
        title: "Thành công",
        description: "Đã cập nhật slider",
      })
      ...
      toast({
        title: "Lỗi",
        description: "Không thể cập nhật slider",
        variant: "destructive",
      })
    } finally {
      setIsLoading(false)
    ...
    <div className="container mx-auto p-6">
      <div className="flex items-center justify-between mb-6">
        <div className="flex items-center gap-4">
          ...
          <h1 className="text-2xl font-bold">Chỉnh sửa Slider</h1>
        </div>
      </div>
